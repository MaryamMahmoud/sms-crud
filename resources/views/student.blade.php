    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://cdn.pixabay.com/photo/2017/09/02/10/31/learn-2706897_960_720.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>ID</label>
                                <input name="cne" type="text" class="form-control"  placeholder="Enter ID">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>ID</label>
                                <input value="{{ $student->cne }}" name="cne" type="text" class="form-control"  placeholder="Enter ID">
                            </div>
                            <div class="form-group">
                                <label>First name</label>
...
<footer id="footer" class="text-center">
    <p>Copyright 2021 &copy; Maryam</p>
    </footer>
    <!-- Optional JavaScript -->
